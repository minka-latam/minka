                  ...
                  <div className='w-full max-w-3xl mx-auto px-4'>
                    ...
                    <div className='text-center mb-8'>
                      ...
                      <p className='text-gray-600 max-w-2xl mx-auto'>
                        ...
                        cantidad que prefieras y contribuye
                        a generar impacto. Minka retiene un
                        porcentaje de donación para cubrir
                        costos operativos y garantizar el
                    ...
                    <div className='bg-white rounded-lg shadow-sm p-6 mb-8 border border-black'>
                      ...
                      <div className='mb-6'>
                        <p className='text-sm text-black mb-3'>
                          ...
                          contribución voluntaria a Minka te
                          permite ser parte de la comunidad
                ...
                <div className='min-h-[600px] flex items-center justify-center'>
                  <div className='w-full max-w-3xl mx-auto px-4'>
                    ...
                    <div className='text-center mb-8'>
                      ...
                      <p className='text-gray-600 max-w-2xl mx-auto'>
                        Tu ayuda está a un paso de impulsar
                        sueños. Confirma tu aporte y haz
                        crecer esta causa.
                      </p>
                    </div>
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div>
                            <p className='text-sm text-[#2c6e49] font-medium mb-1'>
                              Acerca del aporte voluntario a
                              Minka
                            </p>
                            <p className='text-sm text-gray-700 leading-relaxed'>
                              Tu aporte voluntario
                              seleccionado para Minka es{' '}
                              {selectedTipText}. Este monto
                              ayuda a mantener la plataforma
                              funcionando, procesar pagos de
                              forma segura y brindar soporte
                              a las campañas.
                            </p>
                          </div>
                        </div>
