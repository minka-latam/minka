...
export function CampaignCard({
  ...
  return (
    <Link
      ...
      className={`block h-full rounded-2xl overflow-hidden border-4 transition-shadow duration-300 hover:shadow-lg ${
        verified ? "border-[#8fbea0]" : "border-transparent"
      }`}
    >
      <div className="bg-white rounded-2xl overflow-hidden group relative h-full flex flex-col h-[520px]">
