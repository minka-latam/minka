...
export function CampaignCard({
  ...
  const isPendingReview =
    status === 'draft' && Boolean(submittedForReviewAt)
    ...
    >
      ...
      <div className='p-3 overflow-hidden'>
        ...
        <div className='flex items-center gap-2 mb-2'>
          ...
          >
            <span className='text-lg inline-block leading-none'>
              •
            </span>{' '}
            {getStatusDisplay()}
          </span>
        ...
        <div className='flex text-sm text-gray-600 mb-3 overflow-hidden'>
          <span className='mr-4 truncate max-w-[50%]'>
            {category}
          </span>
          ...
          <div className='flex flex-col sm:flex-row gap-2 sm:gap-0 sm:justify-between flex-wrap lg:flex-nowrap'>
            ...
            >
              ...
              {!isCancelled ? (
                ...
                <EyeIcon className='ml-1 flex-shrink-0 h-3 w-3 sm:h-4 sm:w-4' />
              )}
            </Button>
          </div>
        ) : (
